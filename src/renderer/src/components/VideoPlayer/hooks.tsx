...
import { EpisodeInfo, Store } from '@shared/types'
    ...
    if (watchEpisodeStatus === 'succeeded' && container && episodeInfo !== null) {
      ...
      const check = () => {
        ...
        if (!refs.handledSpecificOptions) {
          refs.handledSpecificOptions = handleSpecificOptions(info.option, contents, episodeInfo)
        }
      ...
      const checkFs = () => {
        ...
        if (!refs.handledFullscreen) {
          refs.handledFullscreen = handleFullScreen(info.option, contents, episodeInfo)
        }
