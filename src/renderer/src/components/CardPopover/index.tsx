...
const ScaleOnHover: FC<ScaleOnHoverProps> = ({ in: inProp, children, onExited, onEnter }) => {
...
export const CardPopover: FC<CardPopoverProps> = memo(({ open, children, anchorEl, onClose }) => {
  const floatingContainerRef = useRef<HTMLDivElement>(null)
  const [position, setPosition] = useState<MixedPosition | null>(null)
          ...
          if (containerRect) {
            ...
            setPosition({
              ...
              relative: {
                ...
                bottom: ancElRect.bottom - containerRect.top + scrollTop
              },
              windowRelative: {
                left: ancElRect.left,
                top: ancElRect.top,
